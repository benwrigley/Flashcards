...
@if ($flashcards->count() > 0)
    <div class="grid grid-cols-12 ml-10 items-center lg:space-y-2">
        <div class="col-span-6 lg:col-span-8 italic underline">
            Flashcards
        </div>
        <div class="col-span-4 lg:col-span-2 flex justify-center italic underline">
            Average Score
        </div>
